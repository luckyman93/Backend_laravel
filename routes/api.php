...
Route::group([
    ...
    Route::post('sanctumregister', 'App\Http\Controllers\AuthController@createUser');
    Route::post('sanctumlogin', 'App\Http\Controllers\AuthController@loginUser');

    Route::post('logout', 'App\Http\Controllers\AuthController@logout');
    Route::post('refresh', 'App\Http\Controllers\AuthController@refresh');
    Route::post('me', 'App\Http\Controllers\AuthController@me');

    Route::get('getAuthUser', 'App\Http\Controllers\AuthController@getAuthUser');
    ...
    Route::get('meUser', 'App\Http\Controllers\AuthController@meUser');
    /* User routes */
    Route::get('getCurrentUser/{id}', 'App\Http\Controllers\Select\UserSelectController@getCurrentUser');
    Route::post("profileAvatarUpload" , "App\Http\Controllers\FilesController@profileAvatarUpload");
    ...
    Route::post('getFilePath', 'App\Http\Controllers\ExcelFilesController@getFilePath');


    Route::post('getUser', 'App\Http\Controllers\FeedbackController@getUser');

});


/*$router->group(['prefix' => '', 'middleware' => 'auth'], function () use ($router) {
    $router->get('getUser', 'App\Http\Controllers\FeedbackController@getUser');
});*/



/*Route::post('/auth/sanctumregister', [App\Http\Controllers\AuthenticationController::class, 'createUser']);
Route::post('/auth/sanctumlogin', [App\Http\Controllers\AuthenticationController::class, 'loginUser']);*/
